...
export function TeamCard({ imgsrc = "https://links.aryanranderiya.com/l/default_user", name, position }) {
    ...
    return (
        <div className={`flex flex-col p-[2em] items-center gap-5 bg-[#00ff7b] bg-opacity-15 rounded-none z-[1] hover:translate-y-[-5px] w-[240px]  transition-all outline-1 hover:outline outline-[#00ff7b] ${visible ? 'opacity-100' : 'opacity-0'}`} ref={cardRef}>
