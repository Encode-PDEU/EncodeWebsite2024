...
export const SocialIcon = ({ href, children }) => (
  <a
    ...
    className="inlinef-flex items-center text-white hover:text-green-500 hover:scale-110 transition-all duration-100"
  >
    {children}
  </a>
);
...
export const ContactTwitterIcon = () => (
